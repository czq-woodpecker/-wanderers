 ...
 *
 */
public class BeautyArticleCommentDao implements ICommentDao {
	...
	public ResultSet getArticleContent(Connection con, String questionId) throws Exception {
		StringBuffer sql = new StringBuffer("select * from t_beautyarticles");
...
//		public boolean addArticleContent(Connection con,Comment artCon,String questionId) throws Exception{
		String sql = "insert into t_beautyarticles (id,exchangeId,answerName,content,time) values (null,?,?,?,?)";
