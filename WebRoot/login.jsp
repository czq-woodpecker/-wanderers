...
<script type="text/javascript" src="bootstrap3/js/jquery-1.9.0.min.js"></script>
<script type="text/javascript" src="bootstrap3/js/login.js"></script>
<link href="bootstrap3/css/login2.css" rel="stylesheet" type="text/css" />
</head>
<body>
<h1>流浪者</h1>
...
<div class="yejiao"><%@ include file="foot.jsp" %>  </div>
</body></html>