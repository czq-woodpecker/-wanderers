...
%>
<%@ page import="com.pet.action.FeedKnowledgeListAction,com.pet.action.FeedKnowledgeCommentAction,com.pet.model.*" %>
    ...
    <!-- top -->
  	...
  	<%
  	  		int pageNo;
  	  	  	  	  	  	  	  	  		...
  	  	  	  	  	  	  	  	  		FeedKnowledgeCommentAction content = new FeedKnowledgeCommentAction();
