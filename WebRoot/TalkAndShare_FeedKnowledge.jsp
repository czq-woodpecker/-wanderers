	                    	...
	                    	<article class="format-standard type-post hentry clearfix">
	                         	<header class="clearfix">
	                                ...
	                                <div class="post-meta clearfix">
	                                    ...
	                                    <span class="comments"><a style="color:gray" href="TalkAndShare_FeedKnowledge_comment.jsp?id=${articleList.id }"><c:out value="${articleList.comments }"></c:out>&nbsp;Comments</a></span>
	                                	<span class="like-count">66</span>
	                                 </div>
	                               <!-- end of post meta -->
	                            </header>
	                            <p><c:out value="${articleList.summary }"></c:out>......<a class="readmore-link" href="TalkAndShare_FeedKnowledge_comment.jsp?id=${articleList.id }">Read more</a></p>
	                         </article>
                        </c:forEach>   		
                        <div id="pagination">
